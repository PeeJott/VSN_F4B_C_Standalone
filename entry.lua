...
mount_vfs_texture_path  (current_mod_path.."/Textures/VSN_F4B_CPT")
...
dofile(current_mod_path.."/LUA/Views_F4BPit.lua")
...
F4B.old             = 6 -- SU27-3, SU33-4, F-15-6, SU25-54
dofile(current_mod_path.."/LUA/Views_F4BPit.lua")
make_view_settings('VSN_F4C', ViewSettings, SnapViews)
make_flyable('VSN_F4C',current_mod_path..'/Cockpit/KneeboardRight/',F4B, current_mod_path..'/comm.lua')--EFM
--make_flyable('VSN_F4C',current_mod_path..'/Cockpit/Scripts/',F4B, current_mod_path..'/comm.lua')--EFM
-------------------------------------------------------------------------------------
dofile(current_mod_path..'/VSN_F4B.lua')
dofile(current_mod_path..'/VSN_F4C.lua')
dofile(current_mod_path.."/WEAPONS/Weapons.lua")
dofile(current_mod_path.."/WEAPONS/VSN_F4B_Gunpod.lua")
-------------------------------------------------------------------------------------
plugin_done()
