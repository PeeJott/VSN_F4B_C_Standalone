...
local radar_range_value = radar_scale_value_param:get("RADAR_RANGE_SCALE")


local Range_10 					= CreateElement "ceSimple"
Range_10.name  					= create_guid_string()
...
AddRadarRangeScale(Range_10.name, radar_range_value)

local Range_20 					= CreateElement "ceSimple"
Range_20.name  					= create_guid_string()
...
AddRadarRangeScale(Range_20.name, radar_range_value)

local Range_40 					= CreateElement "ceSimple"
Range_40.name  					= create_guid_string()
...
AddRadarRangeScale(Range_40.name, radar_range_value)
]]
