...
SetScale(MILLYRADIANS) --das setzt eine Betrachtungsweise/Scala für die Maßangaben. Anderer Möglichkeiten in (FOV) oder (MILLYRADIANS) gem. elements_defs.lua im Installationsordner 

--Diese Materials werden anders benutzt. Für HUD-Materials die Local-Aufzählung unten benutzen---------------
materials = {}
materials["GUN_PIPPER_ORANGE"]	=	{255.0, 139.0, 50.0, 220.0}
...
HUD_GUNPIPPER_TEXT = MakeMaterial(HUD_TEXTURES_PATH.."F4_GUNSIGHT_ONE_600x600.tga", GunpipperOrange)
