...
hud_glass_clipping_mask.vertices		= {{-50, 95}, {-84, 70}, {-84, -95}, {82, -95}, {82, 70}, {50, 95},}
...
cockpit_base_clipping_mask.vertices			= {{-700.0, 700.0}, {-700.0, -700.0}, {700.0, -700.0}, {700.0, 700.0},}
