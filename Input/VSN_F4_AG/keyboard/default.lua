...
--special und WiP
{combos = {{key = 'x', reformers = {'LAlt'}}}, down = iCommandPlaneRightMFD_OSB18, name = _('Wingtips UP/DOWN'), category = _('special WiP')},	-- command Nr.689
{combos = {{key = 'u', reformers = {'LCtrl'}}}, down = iCommandPlaneShipTakeOff, name = _('Catapult Hook-Up'),	category = _('special WiP')}, -- command Nr. 120
{combos = {{key = 'S', reformers = {'LShift','LCtrl'}}},	down = iCommandPilotGestureSalute,	name = _('Pilot Salute'),	category = _('special WiP')},
{combos = {{key = 'l', reformers = {'LShift','LCtrl'}}}, down = iCommandPlaneRightMFD_OSB6_Off, name = _('Launch Bar Toggle'), category = _('special WiP')}, -- command Nr.1012
})
return res
